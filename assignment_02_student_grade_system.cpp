...
// =============================================================================
// Determines the letter grade for a given student score.
// Returns '\0' (null character) if the score is out of the valid range [0, 100].
...
int main() {
    ...
    // Call getGrade() and handle output or out-of-range error
